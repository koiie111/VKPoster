...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand" href="/"><?=$Core->name?></a>
        ...
        <?if(!isset($User)){?>
            <div class="col-md-3 text-end">
                <a type="button" class="btn btn-primary" href="/auth">Войти через ВК</a>
            </div>
        <?}else{?>
            <div class="dropdown text-end">
                <a href="#" class="d-block link-body-emphasis text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="<?=$Core->outputText($User->avatar)?>" alt="mdo" width="32" height="32" class="rounded-circle">
                </a>
                <ul class="dropdown-menu text-small">
                    <li><a class="dropdown-item" href="#"><?=$Core->outputText($User->firstName . " ". $User->lastName)?></a></li>
                    <li><hr class="dropdown-divider"></li>
